...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  for($i = 0; $i < count($_POST['nom']); $i++){
    $e = Etudiant::getEtudiantByName($_POST['prenom'][$i],$_POST['nom'][$i]);
    var_dump($e);
    ...
    if($e != null){
      ...
      //si il appartient deja a un groupe stop
      if($res != null){
        return;
    ...
    //sinon on l'insert dans la table étudiant et on l'ajoute au tableau
      ...
      array_push($etu,Etudiant::addEtudiant($_POST['nom'][$i], $_POST['prenom'][$i]));
    }
  }
